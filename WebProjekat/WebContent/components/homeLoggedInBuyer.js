Vue.component("homeLoggedInBuyer", {
  ...
  <div>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <div class="container-fluid" style="background-color: #AEDB9F;">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <li><a class="dropdown-item" href="http://localhost:8389/WebShopREST/#/login">Log out</a></li>
            </ul>
            </li>
        ...
        <li class="nav-item">
        <a class="nav-link" @click="goToObjects()">Sports Objects</a>
        </li>
        <li class="nav-item">
        <a class="nav-link" @click="goToRAndom()">Random</a>
        </li>
          ...
          methods: {
            ...
            goToObjects: function(){
              ...
              goToRAndom: function(){
              this.$router.push("/random/"+this.id)
            }
